...
const outDir = "output/piston-targeted";
...
const script = fs.readFileSync("piston-targeted-eval.js", "utf8");
const result = await page.evaluate(script);
await page.screenshot({ path: path.join(outDir, "piston-targeted.png"), fullPage: true });
